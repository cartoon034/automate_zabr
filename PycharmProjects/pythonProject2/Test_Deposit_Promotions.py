...
if __name__ == '__main__':
    ...
    try:
        ...
        def Create_Deposit():
            ...
            Remark_Deposit.send_keys('ทดสอบฝากรับโปรโมชั่น')
        ...
        def Cancel():
            ...
            User_Promotions = browser.find_element(By.XPATH, '/html/body/div/div/div/div/div[1]/div[2]/div[1]/div[2]/div/div/div/div/ul/li[6]/ul/li[3]')
        ...
        Note.send_keys('ทดสอบสร้างบิลโน๊ต')
